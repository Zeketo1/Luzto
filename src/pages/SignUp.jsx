...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (password !== confirmPassword) {
      ref3.current.classList.add("border", "border-b-[#ff0000]", "border-b-2");
      ...
      if (name !== "") {
        addUsername(name, lastName, email);
      }
    }
  };
    ...
    <div className="lg:grid lg:grid-cols-2 w-full sm:h-[93.10vh] font-poppins">
      ...
      >
        ...
        <div className="relative w-full h-full flex flex-col items-center justify-center gap-5">
          <h1 className="text-[30px] text-white text-center">WELCOME</h1>
          <form
          ...
          >
            ...
            <p className="text-[13px] font-semibold">Sign up with Google</p>
          </div>
        </div>
      </div>
      <div
      ...
      <div className="h-full flex lg:hidden justify-center items-center sm:bg-signupBg sm:bg-cover sm:bg-center sm:bg-no-repeat">
        ...
        <div className="glassLog relative w-full px-[10%] py-6 sm:py-3 h-full sm:h-[550px] sm:w-[75%] sm:p-10 flex flex-col justify-center gap-5">
          ...
          <div className="w-full flex justify-center">
            <div
              onClick={handleGooogle}
              className="w-fit flex cursor-pointer items-center gap-2 py-2 px-4 bg-white rounded-md border-[#8080805c] border"
            >
              <img src={googleIcon} alt="" className="h-[20px]" />
              <p className="text-[13px] font-semibold">Sign up with Google</p>
            </div>
